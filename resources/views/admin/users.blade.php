                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$user->showPass}}</td>
                            <td>{{$user->uid}}</td>
                            <td>{{number_format($user->fuel_balance,2,".","")}}</td>
                            <td>{{number_format($user->epin_balance,2,".","")}}</td>
                            {{-- <td>{{number_format($user->main_balance,8,".","")}}</td> --}}
                            <td>{{$user->sp_name}}</td>
                            <td>{{$user->spid==null?"Admin":$user->spid}}</td>
                            {{-- <td>{{$user->is_active == 0 ? "G0":$user->rank}}</td> 
                            ...
                            <td class="d-flex" >
                                ...
                                <a href="{{route('admin.sendEpin',$user->id)}}" class="btn btn-secondary btn-sm mr-2">Send EPIN Balance</a>
                                @if($user->is_active == 0)
